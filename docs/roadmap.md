...
- 4 本の設計 RFC はいずれも実装済み: [`0001`](rfc/0001-component-model.md) コンポーネントモデルと状態管理（`G11`〜`G14`、#86）、[`0002`](rfc/0002-async-event-injection.md) 非同期イベント注入（#84）、[`0003`](rfc/0003-text-input-ime.md) テキスト入力 widget + IME preedit（`G6`/`G19`、#88）、[`0004`](rfc/0004-dispatch-registration.md) dispatch のランタイム登録（#125。registry 消費の残件は #132）。5 本目の [`0005`](rfc/0005-build-driver-redesign.md) build driver の再設計（#132 + #126 合同）は設計確定・実装中。
